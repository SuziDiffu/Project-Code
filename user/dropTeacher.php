...
// Handle form submission to drop a tutor
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $tutor_id = $_POST['tutor_id'];

    // Prepare and execute SQL to delete the tutor
    $sql_delete = "DELETE FROM tutors WHERE tutor_id = ?";
    $stmt_delete = $connection->prepare($sql_delete);
    $stmt_delete->bind_param('i', $tutor_id);
    if ($stmt_delete->execute()) {
        $message = "Tutor with ID $tutor_id has been successfully dropped.";
    } else {
        $message = "Failed to drop the tutor. Please try again.";
    }
}
?>
    ...
    <div class="main">
        <div class="content">
            ...
            <form method="POST" action="">
                ...
                <input type="submit" value="Drop Tutor">
            </form>
        </div>
    </div>
    <footer>
