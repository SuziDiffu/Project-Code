<?php
session_start();
require '../database/db.php'; // db.php is in a directory called database at the same level as payment.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql_insert = "INSERT INTO payments (session_id, tutor_id, amount, date, status) VALUES (?, ?, ?, ?, 'pending')";
    $stmt_insert = $connection->prepare($sql_insert);
    $stmt_insert->bind_param('iids', $session_id, $tutor_id, $amount, $date);
    $stmt_insert->execute();
    $stmt_insert->close();
    ...
    <div class="main">
        <div class="content">
            ...
            <form method="POST" action="payment.php">
                ...
                <label for="amount">Amount Ksh.(100 per hr):</label>
